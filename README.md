...
ID Name    Description dir  Nom.           Tol. Sen.    Relative Bounds Process Sigma    k C_p C_pk       μ       σ μ_eff   σ_eff Yield Probability Reject PPM
 0    a          Shaft   + 208.0 ± 0.036           1 [207.964, 208.036]          ± 6σ 0.25 2.0  1.5 208.009   0.006 208.0   0.008       99.99932047        6.8
...
ID            Name      Description dir Nom.              Tol. Sen. Relative Bounds
 7 Closed Analysis stacks on stacks   + 0.25 + 0.533 / - 0.233    1  [0.017, 0.783]

Dimension: WC Analysis - stacks on stacks
ID        Name      Description dir Nom.           Tol. Sen. Relative Bounds
 8 WC Analysis stacks on stacks   +  0.4 ± 0.383           1  [0.017, 0.783]

Dimension: RSS Analysis (assuming ± 3σ inputs) - stacks on stacks
ID                                Name      Description dir Nom.           Tol. Sen.    Relative Bounds Process Sigma k C_p C_pk   μ       σ μ_eff   σ_eff Yield Probability Reject PPM
10 RSS Analysis (assuming ± 3σ inputs) stacks on stacks   +  0.4 ± 0.17825         1 [0.22175, 0.57825]          ± 3σ 0 1.0  1.0 0.4 0.05942   0.4 0.05942       99.73002039     2699.8

Dimension: MRSS Analysis (assuming ± 3σ inputs) - stacks on stacks
ID                                 Name      Description dir Nom.           Tol. Sen.    Relative Bounds Process Sigma k     C_p    C_pk   μ       σ μ_eff   σ_eff Yield Probability Reject PPM
12 MRSS Analysis (assuming ± 3σ inputs) stacks on stacks   +  0.4 ± 0.24046         1 [0.15954, 0.64046]    ± 3.76693σ 0 1.25564 1.25564 0.4 0.06383   0.4 0.06383       99.98347307     165.27

Dimension: '6 Sigma' Analysis - stacks on stacks
ID               Name      Description dir Nom.           Tol. Sen.    Relative Bounds Process Sigma k C_p C_pk   μ       σ μ_eff   σ_eff Yield Probability Reject PPM
14 '6 Sigma' Analysis stacks on stacks   +  0.4 ± 0.26433         1 [0.13567, 0.66433]        ± 4.5σ 0 1.5  1.5 0.4 0.05874   0.4 0.05874       99.99932047        6.8

Spec: stack spec
      Name Description                                                            Dimension Spec. Limits       k     C_p    C_pk     μ Yield Probability Reject PPM
stack spec             16: '6 Sigma' Analysis stacks on stacks +0.4 ± 0.26433 @ ±4.5σ & k=0  [0.05, 0.8] 0.14187 2.12804 1.98617 0.425               100          0
```
