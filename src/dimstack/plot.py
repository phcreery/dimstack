...
class StackPlot:
    ...
    def add_dimension(self, item: Basic, start_pos: float = 0, xbins_size=None):
    ...
    def add(self, item: Union[Basic, Reviewed, BasicStack, ReviewedStack]):
