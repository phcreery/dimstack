...
class McGrawHill_2(unittest.TestCase):
    m1 = dimstack.dim.Basic(nom=0.875, tol=dimstack.tolerance.Bilateral.symmetric(0.010), a=-0.5146, name="A")
    m2 = dimstack.dim.Basic(nom=1.625, tol=dimstack.tolerance.Bilateral.symmetric(0.020), a=0.1567, name="B")
    m3 = dimstack.dim.Basic(nom=1.700, tol=dimstack.tolerance.Bilateral.symmetric(0.012), a=0.4180, name="C")
    m4 = dimstack.dim.Basic(nom=0.875, tol=dimstack.tolerance.Bilateral.symmetric(0.010), a=-1.000, name="D")
    m5 = dimstack.dim.Basic(nom=2.625, tol=dimstack.tolerance.Bilateral.symmetric(0.020), a=-0.0540, name="E")
    m6 = dimstack.dim.Basic(nom=7.875, tol=dimstack.tolerance.Bilateral.symmetric(0.030), a=0.4372, name="F")
    m7 = dimstack.dim.Basic(nom=4.125, tol=dimstack.tolerance.Bilateral.symmetric(0.010), a=1.000, name="G")
    m8 = dimstack.dim.Basic(nom=1.125, tol=dimstack.tolerance.Bilateral.symmetric(0.020), a=-0.9956, name="H")
    m9 = dimstack.dim.Basic(nom=3.625, tol=dimstack.tolerance.Bilateral.symmetric(0.015), a=-0.7530, name="J")
    m10 = dimstack.dim.Basic(nom=5.125, tol=dimstack.tolerance.Bilateral.symmetric(0.020), a=-0.4006, name="K")
    m11 = dimstack.dim.Basic(nom=1.000, tol=dimstack.tolerance.Bilateral.symmetric(0.010), a=-1.0914, name="M")
    dims = [m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11]
